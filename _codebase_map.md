...
> 自动生成 by `ag_indexer` | 更新时间: 2026-04-19 22:45
> ⚠️ 此文件由机器自动生成，请勿手动编辑
...
| ag_core/ag_evolve.py | Python | 994 | _fetch_json(), _fetch_text(), _translate_text(), _translate_batch() | base64, json, os, re | 
...
| ag_core/ag_review_army.py | Python | 407 | ReviewArmy | asyncio, ast, json, os | 
...
- **ReviewArmy** (L16): `__init__()`, `_analyze_testing()`, `_analyze_security()`, `_analyze_consistency()`, `run_review()`, `run_review_army()`, `_report_findings()`
